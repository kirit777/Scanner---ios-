    ...
    private func setupConstraints() {
        ...
        if #available(iOS 11.0, *) {
            ...
            if let safeAreaInsets = window?.safeAreaInsets {
                toolbarConstraints.append(toolbar.heightAnchor.constraint(equalToConstant: safeAreaInsets.top + 10.0))
            }
            
            cancelButtonConstraints = [
                cancelButton.leftAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leftAnchor, constant: 10.0),
                view.safeAreaLayoutGuide.bottomAnchor.constraint(equalTo: cancelButton.bottomAnchor, constant: (30.0 / 2) - 10.0)
            ]
            ...
            cancelButtonConstraints = [
                ...
                view.bottomAnchor.constraint(equalTo: cancelButton.bottomAnchor, constant: (30.0 / 2) - 10.0)
            ]
